...
.method public constructor <init>(Ljq/c;Landroidx/room/u;)V
    ...
    .line 1
    iput-object p1, p0, Ljq/c$c;->d:Ljq/c;
...
.method public e()Ljava/lang/String;
    ...
    .line 1
    const-string v0, "UPDATE OR ABORT `conversation` SET `id` = ?,`uniqueId` = ?,`nickName` = ?,`logo` = ?,`draft` = ?,`isPin` = ?,`remindType` = ?,`unreadCount` = ?,`lastLocalId` = ?,`lastMsgId` = ?,`lastReadLocalId` = ?,`lastReadMsgId` = ?,`displayTime` = ?,`updateTime` = ?,`summary` = ?,`lastMessageStatus` = ?,`q1` = ?,`q2` = ?,`r1` = ?,`r2` = ?,`ext` = ? WHERE `id` = ?"
...
.method public bridge synthetic i(Lo1/k;Ljava/lang/Object;)V
    ...
    .line 2
    .line 3
    invoke-virtual {p0, p1, p2}, Ljq/c$c;->l(Lo1/k;Lcom/baogong/chat/datasdk/service/conversation/db/ConversationPO;)V
...
.method public l(Lo1/k;Lcom/baogong/chat/datasdk/service/conversation/db/ConversationPO;)V
    .registers 7
